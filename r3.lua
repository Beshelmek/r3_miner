-- r3 is a fork of https://github.com/Starkus/quarry
os.loadAPI("inv")
os.loadAPI("t")
	...
	if success then
		if data.name == "minecraft:chest" then
			...
			for i=1, 16 do
				...
				if data ~= nil and
						(data.name == "minecraft:coal" or
						 data.name == "minecraft:charcoal" or
						 data.name == "modern_industrialization:lignite_coal") == false then
					turtle.drop()
				end
			end
		end
	...
	for i=1, 16 do
		...
		if item and
				(item.name == "minecraft:coal" or
				 ...
				 item.name == "modern_industrialization:lignite_coal") and
